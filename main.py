...
def __parse_input_files(args) -> Session:
...
def __call_linters(session:Session, args):
...
def __call_emiters(session: Session, args):
...
if __name__ == "__main__":
    ...
    session: Session = __parse_input_files(args)
